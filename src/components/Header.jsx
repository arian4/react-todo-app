...
export default function Header({theme,setTheme}) {
  return (
    <div className="flex justify-between">
        <h2 className="text-4xl font-bold text-white">Todo</h2>
        {
          theme === 'light' ?
          // moon 
          <svg onClick={() => setTheme('dark')} className='cursor-pointer' xmlns="http://www.w3.org/2000/svg" width="26" height="26">
          ...
          :
          // sun
          <svg onClick={() => setTheme('light')} className='cursor-pointer' xmlns="http://www.w3.org/2000/svg" width="26" height="26">
